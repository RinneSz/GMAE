...
[ -z "${n_encoder_layers}"] && n_encoder_layers="24"
[ -z "${n_decoder_layers}"] && n_decoder_layers="1"
[ -z "${dataset_name}"] && dataset_name="DHFR"
...
python entry.py --num_workers 8 --seed $seed --batch_size 64 \
